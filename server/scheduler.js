...
function aggregatePeriod(code, startStr, endStr) {
    ...
    Object.keys(routeGroups).forEach(function (key) {
        ...
        // RMTO class mapping: C1=a C2=b C3=c C4=d C5=e
        // Note: "x" (unclassified vehicles) is intentionally excluded from RMTO submission -
        // RMTO rejects/errors on these, so they are counted in local reception (irawdata)
        // but never included in C5, speed averages, or violation totals sent onward.
